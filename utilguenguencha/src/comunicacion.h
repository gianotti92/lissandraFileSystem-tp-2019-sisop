...
typedef enum {
	BAD_KEY, MISSING_TABLE, UNKNOWN, BAD_REQUEST, MISSING_FILE, CONNECTION_ERROR, MEMORY_FULL, LARGE_VALUE, INSERT_FAILURE, NULL_REQUEST, BAD_OPERATION, BAD_PARTITION, BAD_COMPACTATION, BAD_CONSISTENCY, BAD_MEMORY
} Error_set;
